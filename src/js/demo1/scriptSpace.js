...
var camera = new THREE.PerspectiveCamera( 75, window.innerWidth / window.innerHeight, .12, 2000 );
...
function update() {
  ...
  var camPos = spline.getPoint(camPosIndex / 100000);
...
for (var i = 0; i < 400; i++) {
  var b = new THREE.Mesh(
    ...
    new THREE.MeshBasicMaterial({color: "#550d73"})
  );
